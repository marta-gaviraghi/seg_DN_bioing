...
1) resampling_normalize_2.m: Resamples and normalizes the B0 image in the HCP space.

2) CNN_postprocessing_3.m: Performs CNN-based DN segmentation.
...
```bash
      git@github.com:marta-gaviraghi/seg_DN_bioing.git
```
